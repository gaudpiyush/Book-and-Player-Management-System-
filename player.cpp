...
Players::Players(int& srno,char* name,int& jno,int& matches,int& runs,int& wickets)
{
	this->srno=++srno;
...
void Players::setSerialno(int srno)
{
	this->srno = srno;
}
...
void Players::display()
{
	...
	cout<<"\t|____________________|__________|_________|_________|__________|\n";
}
